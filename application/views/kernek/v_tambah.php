<div class="content-wrapper">
    ...
    <div class="card card-primary card-outline ml-2 mr-2" style="min-height: 480px !important;">
        <form role="form" action="<?= base_url('kernek/tambah') ?>" method="POST" enctype="multipart/form-data">
            <div class="card-body">
                <div class="form-group">
                    <label for="nama">Nama Kernek</label>
                    <input type="text" class="form-control" id="nama" placeholder="Nama Kernek" name="nama">
