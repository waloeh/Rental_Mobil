<div class="content-wrapper">
    ...
    <div class="card card-primary card-outline ml-2 mr-2">
                        ...
                        <div class="col-md-10 col-sm-12">
                            <div class="row">
                                <div class="col-md-3 col-sm-12">
                                    <input type="date" class="form-control mb-2" name="awal" id="awal">
                                </div>
                                <div class="col-md-3 col-sm-12 mb-2">
                                    <input type="date" class="form-control" name="akhir" id="akhir">
                                </div>
                                <div class="col-md-1 col-sm-12 mb-2">
                                    <button type="button" class="form-control btn btn-info" id="cari-pemasukan"><i class="fa fa-search"></i></button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="card-body" style="min-height: 480px !important;">
            ...
            <table id="data-pemasukan" class="table table-bordered table-sm table-hover " style="width: 100%; margin-top: 0 !important;">
                <thead>
                ...
                <tbody id="show-data-pemasukan"></tbody>
            </table>
        </div>
    </div>
</div>