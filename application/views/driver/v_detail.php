                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle" src="<?php echo base_url('assets/images/drivers/' . $dataDriver['gambar']) ?>" alt="User profile picture" style="width: 200px; max-height: 200px; overflow: auto;">
                                    </div>

                                    <h3 class="profile-username text-center"><?php echo $dataDriver['nama_driver'] ?></h3>

                                    <p class="text-muted text-center"><?php echo $dataDriver['alamat'] ?></p>
                                    ...
                                    <ul class="list-group list-group-unbordered mb-3 text-center">
                                        ...
                                        <li class="list-group-item">
                                            <b>Almat : </b> <b class=""><?php echo $dataDriver['alamat'] ?></b>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Jenis Kelamin : </b> <b class=""><?php echo $dataDriver['jenis_kelamin'] ?></b>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Email : </b> <b class=""><?php echo $dataDriver['email'] ?></b>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Nomor Hp : </b> <b class=""><?php echo $dataDriver['no_hp'] ?></b>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Status : </b> <b class=""><?php if ($dataDriver['status'] == 1) {
                                                                                echo "Siap";
                                                                            } else {
                                                                                echo "Jalan";
                                                                            } ?></b>
